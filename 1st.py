...
def finding_parameters(trial):
    hidden_layer1 = trial.suggest_int("hidden_layer_sizes", 10, 50)
    hidden_layer2 = trial.suggest_int("hidden_layer_sizes2", 10, 50)
    max_iter = trial.suggest_int("max_iter", 10, 50)
    random_state = trial.suggest_int("random_state", 10, 50)

    model = MLPRegressor(hidden_layer_sizes=(hidden_layer1, hidden_layer2), max_iter=max_iter, random_state=random_state)
